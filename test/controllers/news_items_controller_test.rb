...
class NewsItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create news_item" do
    assert_difference('NewsItem.count') do
      post news_items_url, params: { news_item: { content: @news_item.content, image: @news_item.image, sub_header: @news_item.sub_header, title: @news_item.title } }
    end
  ...
  test "should update news_item" do
    patch news_item_url(@news_item), params: { news_item: { content: @news_item.content, image: @news_item.image, sub_header: @news_item.sub_header, title: @news_item.title } }
